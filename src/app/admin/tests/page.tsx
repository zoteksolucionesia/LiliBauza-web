  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: colors.background }}>
      <div className="text-center p-12 rounded-3xl shadow-lg" style={{ backgroundColor: colors.surface }}>
        <ClipboardList className="w-16 h-16 mx-auto mb-4" style={{ color: colors.primary }} />
        <h1 className="text-2xl font-bold mb-2" style={{ color: colors.text }}>Módulo de Tests</h1>
